...
const _hoisted_1 = /* @__PURE__ */ createVNode("div", null, "Comp B", -1);
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_comp_a = resolveComponent("comp-a");
  return openBlock(), createBlock(_component_comp_a, null, {
    default: withCtx(() => [
      _hoisted_1
    ]),
    _: 1
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_comp_b = resolveComponent("comp-b");
  return openBlock(), createBlock(_component_comp_b, {class: "x"});
}
